<template>
  <div>
    <mdb-card
      class="card-image"
      style="background-image: url(https://images.unsplash.com/photo-1421217336522-861978fdf33a?ixlib=rb-1.2.1&auto=format&w=1550)"
    >
      <div class="text-white text-center rgba-stylish-strong py-5 px-4">
        <div class="py-5" style="margin-top: -35px">
          <h4 class="h4 orange-text" style="margin-bottom: -20px">
            Music Stats
          </h4>
          <h3 class="card-title h4 my-4 py-2" style="margin-top: -35px">
            Play and view detailed information of your <br />
            favourite tracks and artist
          </h3>
          <div class="sea" style="margin-top: -20px">
          ...
          <p class="mb-4 pb-2 px-md-5 mx-md-5">
            Use the search field below to search for any tracks or artist
            <br />All data is from Spotify <br /><br />
            Made with <i class="fa fa-heart" style="color: red"></i> by Ovuoba
            Sampson. Enjoy
          </p>
        </div>
      </div>
